...
class layer_points(models.Model):
	...
	user = models.ForeignKey(User,related_name='kuband_user_id_fk')
...
class landmarks(models.Model):
	...
	radar = models.ForeignKey('radars')
	segment = models.ForeignKey('segments')
	point_path_1 = models.ForeignKey('point_paths',related_name='point_paths_link_fk2_1')
	point_path_2 = models.ForeignKey('point_paths',related_name='point_paths_link_fk2_2')
