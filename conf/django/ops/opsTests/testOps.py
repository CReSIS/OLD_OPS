...
class getCrossoversTests(TestCase):	
	...
	def test_getCrossovers(self):
		setUp(self)
		# Set the json string
		jsonStr = '{ "properties": { "location": "arctic", "lyr_name": "fixtureTest", "frame": [ "11111111_01_001", "11111111_01_002", "22222222_02_001", "22222222_02_002" ], "segment_id": 1,"userName": "admin", "isAuthenticated": true, "mat": true} }'
